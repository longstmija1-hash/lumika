      ...
      <RevealOnScroll>
        <div className="mb-10 max-w-2xl md:mb-14 text-left">
          ...
          <h2 className="section-heading !mb-2 sm:!mb-4">
            {TRUST_HEADING.replace('результат', '')}{' '}
          ...
          <div className="relative overflow-hidden rounded-[22px] sm:rounded-[32px] border border-[#dce3ff] bg-gradient-to-br from-ums-tint via-white to-[#f7f8ff] lg:col-span-5">
            ...
            <div className="relative aspect-[16/10] sm:aspect-[5/6] lg:aspect-auto lg:h-full lg:min-h-[28rem]">
              <Image
                ...
                alt="Школа и IT на одной платформе Люмика"
                fill
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
                <div className="mb-2.5 inline-flex rounded-full border border-white/50 bg-white/15 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-white backdrop-blur-sm">
                  3 трека
                </div>
                <div className="mb-3 flex flex-wrap gap-2">
                  ...
                  <span className="rounded-full bg-white/95 px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-[#7a5f44]">
                    Гуманитарный
                  </span>
